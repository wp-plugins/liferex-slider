=== LifeRex Slider ===
Contributors: Md. Kamruzzaman, Nadia Afrin, Abdur Rahim
Tags: image slider, images, wordpress slider, jquery slider, responsive
Requires at least: 3.0
Tested up to: 4.2
Stable tag: 1.3.2


A WordPress Image slider based on Life Slider to display image slider on post, page or theme.

== Description ==

It is wonderful image slider which help you to display image in your site or your wordpress pluging directory. It is responsive, You can use this pluging in any device.

= Usage-Custom Post & Shortcode =

You just create your usuable slides from the Slider menu & paste the following shortcode where you want to display this slider:

`[all-nivoslider theme='default|dark|light|bar']`

For example: if you want to add 'light' theme to your site  just write as following code
